...
public class EjbJpaUserStorageProviderFactory implements UserStorageProviderFactory<EjbJpaUserStorageProvider> {
    ...
    public EjbJpaUserStorageProvider create(KeycloakSession session, ComponentModel model) {
        ...
        try {
            ...
            final UserRepository userRepository = (UserRepository) ctx.lookup("java:global/ejb-jpa-keycloak-spi/" + UserRepository.class.getSimpleName());
