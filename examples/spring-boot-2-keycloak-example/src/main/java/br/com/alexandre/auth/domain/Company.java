...
public class Company implements Serializable {
    ...
    public String toString() {
        return "Company [companyId=" + companyId + ", fantasyName=" + fantasyName + ", socialName=" + socialName
                + ", acronym=" + acronym + ", address=" + address + ", neighborhood=" + neighborhood + ", city=" + city
                + ", state=" + state + ", zipCode=" + zipCode + ", phoneDdd=" + phoneDdd + ", phoneNumber="
                + phoneNumber + ", faxDdd=" + faxDdd + ", faxNumber=" + faxNumber + ", cgcNumber=" + cgcNumber
                + ", cgcDigit=" + cgcDigit + "]";
    }
