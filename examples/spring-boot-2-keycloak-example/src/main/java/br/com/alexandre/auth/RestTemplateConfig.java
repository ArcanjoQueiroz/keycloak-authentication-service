...
public class RestTemplateConfig extends AbstractRestTemplateConfig {
    ...
    public RestTemplate getSimpleRestTemplate(final MappingJackson2HttpMessageConverter mappingJackson2HttpMessageConverter, final RestTemplateBuilder restTemplateBuilder) {
    ...
    public RestTemplate getOAuth2RestTemplate(final MappingJackson2HttpMessageConverter mappingJackson2HttpMessageConverter, final RestTemplateBuilder restTemplateBuilder) {
